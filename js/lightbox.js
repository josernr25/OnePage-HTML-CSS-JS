...
var metLightbox = {
    // Agrega el evento Click a todas las imagenes y le asigna la funcion capturaImagen
    inicio: function() {
    ...
    // Obtiene el objeto img que se clickeo y elejuta la funcion lightbox
    capturaImagen: function() {
        propLightbox.imagen = this;
        metLightbox.lightbox(propLightbox.imagen);
    },

    // Define todas las propiedades y estilos para visualisar la imagen en un modal
    ...
    // Cierra el modal con la imagen al hacer click en el boton cerrar
